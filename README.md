...
![유레카프로젝트_지도교수면담](https://github.com/user-attachments/assets/41d0a50f-ff63-42a1-95bd-5cf7de397aa0)

지도교수님과의 면담에서는 전공과 진로에 관한 다양한 이야기를 나눴다. 특히 최근 인공지능 기술이 빠르게 발전하면서 소프트웨어융합대학의 방향과 교육 방식도 상당히 변화하고 있다는 점을 교수님께서 강조하셨다. 실제로 많은 학생들이 이러한 변화 속에서 어떤 분야를 목표로 삼아야 할지, 또 어떤 역량을 갖춰야 할지 고민하고 있다는 이야기도 함께 나누며 공감할 수 있었다. 나는 앞으로 어떤 프로그래밍 언어를 중심으로 공부하는 것이 좋을지 여쭤보았다. 이에 대해 교수님은 특정 언어 하나에만 깊게 파고드는 방식보다는 Python, Java처럼 기본기와 활용 범위가 넓은 언어를 먼저 다져 놓는 것이 중요하다고 조언하셨다. 그 후 자신의 관심 분야가 명확해지면 데이터·AI, 백엔드, 모바일 등 각 분야에서 요구하는 언어와 기술을 자연스럽게 확장해 나가는 것이 더 효율적이라고 강조하셨다. 기술의 유행은 빠르게 바뀌기 때문에, 한 언어에만 의존하기보다는 변화에 대응할 수 있는 기반 역량이 필요하다는 말씀이 인상적이었다. 또한 교수님의 연구에 관해서도 질문을 드리며 연구실 활동과 학부연구생의 역할, 대학원 생활에 대한 현실적인 설명을 들을 수 있었다. 연구가 어떤 흐름으로 진행되며, 실제로 학부생이 참여했을 때 어떤 경험과 배움을 얻을 수 있는지 자세히 알려주셔서 앞으로 연구 참여를 고민하는 데 큰 도움이 되었다. 연구의 어려운 점뿐 아니라 보람 있는 순간들에 대한 이야기까지 들을 수 있어 더욱 의미 있었다. 전반적으로 이번 면담을 통해 전공 분야가 앞으로 어떤 방향으로 움직일지에 대해 보다 명확하게 이해할 수 있었고, 스스로 어떤 준비를 해야 할지에 대한 감각도 잡을 수 있었다. 진로 선택과 학습 방향에 대한 실질적인 조언을 들으며, 앞으로의 계획을 더 체계적으로 세울 수 있을 것 같다는 느낌을 받았다.
